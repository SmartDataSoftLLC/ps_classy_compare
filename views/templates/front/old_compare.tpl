...
{block name='page_title'}
  {l s='Compare Details' d='Shop.Theme.Customeraccount'}
{/block}
{block name='page_content_container'}
  <section class="ccompare-products-comparison-table">
    <div class="ccompare-products-wrapper">
      {if isset($products)}
        <ul class="ccompare-column-headings">
          <li>Image</li>
          <li>Name</li>
          <li>Price</li>
        </ul>
        {foreach from=$products item=product}
          <ul class="ccompare-products-columns">
            <li class="product">
              <a href="#"  data-id-product="{$product.id}"  class="remove_compare_button"> <i class="material-icons ">delete</i></a>
              <div class="product{if !empty($productClasses)} {$productClasses}{/if}">
                <article class="product-miniature js-product-miniature" data-id-product="{$product.id_product}" data-id-product-attribute="{$product.id_product_attribute}">
